...
plots_avg_time = csv.reader(open('generated_euclid_test_avg_time.txt', 'r'), delimiter=';')
plots_max_time = csv.reader(open('generated_euclid_test_max_time.txt', 'r'), delimiter=';')
plots_prd = csv.reader(open('generated_euclid_test_prd.txt', 'r'), delimiter=';')
...
plt.title('Random Euclid Plot - Avg Time')
...
plt.legend()
plt.savefig('generated_euclid_avg_time.png')

plt.clf()
plt.xlabel('n')
plt.ylabel('Time [nanoseconds]')
plt.title('Random Euclid Plot - Max Time')
...
plt.legend()
plt.savefig('generated_euclid_max_time.png')

plt.clf()
plt.xlabel('n')
plt.ylabel('PRD [%]')
plt.title('Random Euclid Plot - Avg PRD')
...
plt.legend()
plt.savefig('generated_euclid_avg_prd.png')
...
plt.plot(x, y_avg_prd_opt, label='2-OPT')
plt.legend()
plt.savefig('generated_euclid_avg_prd_no_krandom.png')