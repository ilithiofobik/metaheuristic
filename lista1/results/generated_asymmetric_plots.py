...
plots_avg_time = csv.reader(open('generated_atsp_test_avg_time.txt', 'r'), delimiter=';')
plots_max_time = csv.reader(open('generated_atsp_test_max_time.txt', 'r'), delimiter=';')
plots_prd = csv.reader(open('generated_atsp_test_prd.txt', 'r'), delimiter=';')
...
plt.title('Random Asymmetric Plot - Avg Time')
...
plt.legend()
plt.savefig('generated_asym_avg_time.png')

plt.clf()
plt.xlabel('n')
plt.ylabel('Time [nanoseconds]')
plt.title('Random Asymmetric Plot - Max Time')
...
plt.legend()
plt.savefig('generated_asym_max_time.png')

plt.clf()
plt.xlabel('n')
plt.ylabel('PRD [%]')
plt.title('Random Asymmetric Plot - Avg PRD')
...
plt.legend()
plt.savefig('generated_asym_avg_prd.png')
...
plt.plot(x, y_avg_prd_opt, label='2-OPT')
plt.legend()
plt.savefig('generated_asym_avg_prd_no_krandom.png')